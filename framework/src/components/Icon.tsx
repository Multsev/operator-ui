...
export type IconName = 'add' | 'remove' | 'refresh' | 'filter' | 'search' | 'settings' | 'check' | 'warning' | 'error' | 'info' | 'chevron' | 'copy' | 'edit' | 'network' | 'log';
...
const paths: Record<IconName, string> = {
  ...
  info: 'M8 7v5m0-8v.1', chevron: 'm5 3 5 5-5 5', copy: 'M5 5h8v9H5zM3 11H2V2h8v1',
